...
\begin{lemma}Вероятность $b_{i, d}^{\tau}(o)$ может быть вычислена по формуле:
...
\end{array}\right.
\end{equation}
В соответствии с предыдущей леммой вероятность $b_{i^\prime,d^\prime}(O_\tau)=b_{i,d}^{\tau}(O_\tau)$ может быть вычислена в соответствии с формулой (\ref{eq:chap3:l3:1}).
\end{proof}
