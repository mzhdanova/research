...
\end{split}
\end{equation}
Для вычисления $\alpha_{t}(j,d)$ Ю предлагает использовать рекуррентную формулу (\ref{eq:chapt1_GHSMM_InverseProblem_alpha_rec})(формула (4) из \cite{Yu}, c.218). Согласно ей запишем:
\begin{equation}
\nonumber
\alpha_{t}(j,d)=\left\{
\begin{array}{ll}
